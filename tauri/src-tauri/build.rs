            ...
            match output {
                Ok(output) => {
                    if !output.status.success() {
                        ...
                        println!("cargo:warning=actool failed to compile icon; using fallback icon resources");
                    } else {
                ...
                Err(e) => {
                    ...
                    println!("cargo:warning=actool is unavailable; using fallback icon resources");
                }
            }
